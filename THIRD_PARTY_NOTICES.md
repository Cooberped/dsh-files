...
- `standard_fonts/LiberationSans*.ttf` is accompanied by
  `LICENSE_LIBERATION` and is licensed under SIL Open Font License 1.1, with
  reserved font names.
...
安装后，字体仍属于独立的 `pdfjs-dist` 包，并继续受各自 BSD/OFL 条款约束。
